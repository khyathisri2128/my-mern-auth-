...
router.post("/login", async (req, res) => {
    ...
    res.cookie("refreshToken", refreshToken, {                                 // cookie anedi backend ki matrame thelisiddi....not frontend. and in javascript gurinchi frontend ki thekusthadhi not backend
        httpOnly: true,
        path: '/',
        secure: false,
        sameSite: "lax"
